...
function EditAccount() {
  ...
  return (
    <div className="mt-8 max-w-3xl mx-auto flex flex-col items-center md:w-[60rem] h-auto shadow-lg">
      ...
      <form className="mt-2 w-full h-full flex flex-col items-center gap-5 p-3">
        <input
          type="file"
          ref={fileRef}
          hidden
        ...
        <input type="text" className="border p-3 rounded-md w-[70%]" />
        <label className="text-slate-500">
          Mobile Number(Will be used for checkout)
        </label>
        <input type="number" className="border p-3 rounded-md w-[70%]" />
        <div className="flex items-center justify-around w-full">
          ...
          <button className="border p-3 rounded-lg bg-slate-800 text-white hover:shadow-xl">
            Update Profile
          </button>
        </div>
      </form>
